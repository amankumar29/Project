      ...
      <form style={{ marginLeft: "360px" }} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-row">
          <div className="form-group col-md-8">
            ...
            />
            {errors.task && (<small className="text-danger">{errors.project.message}</small>)}
          </div>
        </div>
        <div className="form-row">
          <div className="form-group col-md-8">
        ...
        <div className="form-row">
          <div className="form-group col-md-8">
            ...
            />
            {errors.start && (<small className="text-danger">{errors.start.message}</small>)}
        ...
        <div className="form-row">
          <div className="form-group col-md-8">
            ...
            />
            {errors.end && (<small className="text-danger">{errors.end.message}</small>)}
          </div>
        </div>
        <div className="form-row">
                  ...
                  return (
                      <tr key={id}>
                          ...
                          <td>
                              ...
                              <i className="mr-4 fas fa-trash-alt"
